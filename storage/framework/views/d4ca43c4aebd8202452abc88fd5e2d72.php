...
<form method="POST" action="<?php echo e(route('articles.update', $article->id)); ?>" onsubmit="return confirm('Supprimer cette annonce ?')">
<?php echo csrf_field(); ?>
...
<input type="text" name="titre" class="form-control form-control-lg" placeholder="Ex: iPhone 13 Pro Max 256 Go" value="<?php echo e(old('titre', $article->titre)); ?>" required>
</div>

<div class="mb-3">
<label class="form-label fw-medium">Description *</label>
<textarea name="description" class="form-control form-control-lg" rows="5" placeholder="Décrivez votre article en détail..." required><?php echo e(old('description', $article->description)); ?></textarea>
</div>

<div class="row g-3 mb-3">
<div class="col-md-6">
<label class="form-label fw-medium">Prix *</label>
<input type="number" name="prix" class="form-control form-control-lg" placeholder="Ex: 50000" value="<?php echo e(old('prix', $article->prix)); ?>" required>
</div>
<div class="col-md-6">
<label class="form-label fw-medium">Devise *</label>
<select name="currency" class="form-control form-control-lg" required>
<option value="GNF" <?php echo e(old('currency', $article->currency?->value) === 'GNF' ? 'selected' : ''); ?>>GNF (Franc Guinéen)</option>
<option value="FCFA" <?php echo e(old('currency', $article->currency?->value) === 'FCFA' ? 'selected' : ''); ?>>FCFA (Franc CFA)</option>
<option value="USD" <?php echo e(old('currency', $article->currency?->value) === 'USD' ? 'selected' : ''); ?>>USD (Dollar US)</option>
<option value="EUR" <?php echo e(old('currency', $article->currency?->value) === 'EUR' ? 'selected' : ''); ?>>EUR (Euro)</option>
</select>
</div>
</div>
...
<option value="<?php echo e($cat->id); ?>" <?php echo e(old('category_id', $article->category_id) == $cat->id ? 'selected' : ''); ?>><?php echo e($cat->libelle); ?></option>
...
<option value="neuf" <?php echo e(old('condition', $article->condition) === 'neuf' ? 'selected' : ''); ?>>Neuf</option>
<option value="très bon" <?php echo e(old('condition', $article->condition) === 'très bon' ? 'selected' : ''); ?>>Très bon état</option>
<option value="bon" <?php echo e(old('condition', $article->condition) === 'bon' ? 'selected' : ''); ?>>Bon état</option>
<option value="moyen" <?php echo e(old('condition', $article->condition) === 'moyen' ? 'selected' : ''); ?>>État moyen</option>
</select>
</div>
</div>
...
<input type="text" name="localisation" class="form-control form-control-lg" placeholder="Ex: Conakry, Ratoma" value="<?php echo e(old('localisation', $article->localisation)); ?>" required>
</div>

<div class="mb-4">
<div class="form-check form-switch mb-2">
<input class="form-check-input" type="checkbox" name="with_delivery" id="withDelivery" value="1" <?php echo e(old('with_delivery', $article->with_delivery) ? 'checked' : ''); ?>>
<label class="form-check-label fw-medium" for="withDelivery">Proposer la livraison</label>
</div>
<div id="deliveryPriceField" class="<?php echo e(old('with_delivery', $article->with_delivery) ? '' : 'd-none'); ?>">
<label class="form-label">Prix de la livraison (GNF)</label>
<input type="number" name="delivery_price" class="form-control form-control-lg" placeholder="Ex: 15000" value="<?php echo e(old('delivery_price', $article->delivery_price)); ?>">
</div>
</div>
	...
	<div class="row g-2" id="currentImagesContainer">
		...
		<div class="col-12 col-sm-6 col-md-4 col-lg-3 current-image-item">
			<div class="card h-100 shadow-sm" style="position: relative; border-radius: 10px;">
				<img src="<?php echo e($img->url); ?>" style="height: 150px; object-fit: cover; border-radius: 8px 8px 0 0;" alt="Image actuelle">
				<div class="card-body p-2">
					<button type="button" class="btn btn-sm btn-outline-danger w-100 remove-current-image" data-image-id="<?php echo e($img->id); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Souare\Documents\secondmainv2\resources\views\articles\edit.blade.php ENDPATH**/ ?>