        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('magasin.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>

                        <div class="mb-3">
                            <label class="form-label fw-medium">Nom du magasin *</label>
                            <input type="text" name="nom_magasin" class="form-control form-control-lg" value="<?php echo e(old('nom_magasin')); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-medium">Slug (URL)</label>
                            <input type="text" name="slug" class="form-control form-control-lg" value="<?php echo e(old('slug')); ?>" placeholder="Laissez vide pour auto-génération">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="adresse" class="form-control form-control-lg" value="<?php echo e(old('adresse')); ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-medium">Téléphone</label>
                            <input type="tel" name="telephone" class="form-control form-control-lg" value="<?php echo e(old('telephone')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Souare\Documents\secondmainv2\resources\views\magasin\setup.blade.php ENDPATH**/ ?>