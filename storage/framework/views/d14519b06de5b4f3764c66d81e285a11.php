...
<head>
    ...
    <title><?php echo e(config('app.name', 'Seconde Main 224')); ?></title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 0;">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset('assets/img/icon.png')); ?>" width="44" height="44" style="border-radius: 50px; object-fit: cover;">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
                    <ul class="navbar-nav align-items-lg-center text-center">
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/')); ?>">Accueil</a>
                        </li>
                        <?php if(auth()->guard()->check()): ?>
                        <?php $role = auth()->user()->role?->value; ?>
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/articles/create')); ?>">Publier</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/profile/listings')); ?>">Mes annonces</a>
                        </li>
                        ...
                        <?php if($role === 'motard'): ?>
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/motard/tableau-de-bord')); ?>">Livraisons</a>
                        </li>
                        <?php endif; ?>
                        <?php if($role === 'admin'): ?>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/messages')); ?>">Messages
                                ...
                                ?>
                                <?php if($unreadMsg > 0): ?>
                                    <span class="badge bg-danger rounded-pill ms-1" style="font-size:0.65rem;"><?php echo e($unreadMsg); ?></span>
                                <?php endif; ?>
                                <?php endif; ?>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/profile')); ?>">Profil</a>
                        </li>
                        <li class="nav-item mt-2 mt-lg-0">
                            <a class="btn btn-outline-light px-3" href="<?php echo e(url('/logout')); ?>">
                                <i class='bx bx-log-out' style="font-size: 1.2rem;"></i>
                            </a>
                        </li>
                        <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/login')); ?>">Connexion</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-3" href="<?php echo e(url('/register')); ?>">S'inscrire</a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
        ...
        <footer class="bg-dark text-white py-4 mt-5">
            <div class="container">
                <div class="row text-center">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="<?php echo e(url('/nous')); ?>" class="text-white text-decoration-none">Qui sommes-nous ?</a></li>
                            <li><a href="<?php echo e(url('/contact')); ?>" class="text-white text-decoration-none">Contact</a></li>
                ...
                <div class="text-center mt-3 border-top border-secondary-subtle pt-3">
                    <p class="mb-0">&copy; <?php echo e(now()->year); ?> Seconde Main 224. Tous droits réservés.</p>
                </div>
            </div>
        </footer>
    </div>
