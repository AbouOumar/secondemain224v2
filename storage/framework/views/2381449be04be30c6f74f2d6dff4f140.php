                ...
                <div class="card-body p-4">
                            ...
                            <div class="col-md-6">
                                <div class="border rounded p-3">
                                    ...
                                    <p><strong>Date de vérification :</strong> 
                                        <?php echo e(auth()->user()->verified_at->format('d/m/Y')); ?>

                                    </p>
                                    <?php if(auth()->user()->verification_documents): ?>
                                        <p><strong>Type de document :</strong> 
                                            <?php echo e(ucfirst(auth()->user()->verification_documents.type ?? 'Non spécifié')); ?>

                                        </p>
                                        <p><strong>Soumis le :</strong> 
                                            <?php echo e(isset(auth()->user()->verification_documents.submitted_at) ? 
                    ...
                    <?php else: ?>
                        <?php if(session('verification_status')): ?>
                            <div class="alert alert-<?php echo e(session('verification_status') === 'success' ? 'success' : 'danger'); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Souare\Documents\secondmainv2\resources\views\seller\pro\verification.blade.php ENDPATH**/ ?>